...
describe("Document-Copy-BO", () => {
  ...
  it("Document-Copy-BO", () => {
    ...
    // เปิดเมนูหลัก
    // cy.get("button.MuiIconButton-root", { timeout: 10000 })
    //   .should("be.visible")
    //   .first()
    //   .click();
    // cy.wait(100);

    // เลือกเมนู "ข้อมูลคัดสำเนาเอกสารและชำระค่าธรรมเนียม"
    ...
    // เข้า page document copy
    cy.get('a[href="/010501/document-copy"]', { timeout: 10000 }).click();

    // หา row ของผู้ยื่น FO ที่เราต้องการ
